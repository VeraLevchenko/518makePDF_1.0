...
if __name__ == '__main__':
    ...
    df = pd.read_excel('test.xlsx', index_col=0, sheet_name='Лист7')
    ...
    pdf.output("Новые уведомления\Новоильинский_518_жилые помещения.pdf")
    os.startfile("Новые уведомления\Новоильинский_518_жилые помещения.pdf")
